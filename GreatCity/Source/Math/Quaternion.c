...
{
    GCQuaternion Result;
    Result.W = -Quaternion1.X * Quaternion2.X - Quaternion1.Y * Quaternion2.Y - Quaternion1.Z * Quaternion2.Z +
               Quaternion1.W * Quaternion2.W;
    Result.X = Quaternion1.X * Quaternion2.W + Quaternion1.Y * Quaternion2.Z - Quaternion1.Z * Quaternion2.Y +
               Quaternion1.W * Quaternion2.X;
    Result.Y = -Quaternion1.X * Quaternion2.Z + Quaternion1.Y * Quaternion2.W + Quaternion1.Z * Quaternion2.X +
               Quaternion1.W * Quaternion2.Y;
    Result.Z = Quaternion1.X * Quaternion2.Y - Quaternion1.Y * Quaternion2.X + Quaternion1.Z * Quaternion2.W +
               Quaternion1.W * Quaternion2.Z;
